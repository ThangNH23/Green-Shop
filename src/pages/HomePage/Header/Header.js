            ...
            <div className="carousel-inner">
              <div className="carousel-item active">
                ...
                >
                  ...
                  <p className="content-hire">CHO THUÊ CÂY CẢNH TẾT 2016</p>
              ...
              <div
                ...
                >
                  <p className="content-title">GREEN SHOP</p>
                  <p className="content-hire">CHO THUÊ CÂY CẢNH CHẤT LƯỢNG</p>
                  <p className="content-text">
                    <i>
                      (Các loại cây cảnh phù hợp với mọi nhà)
                    </i>
                  </p>
                </div>
                <img
              ...
              <div
                ...
                >
                  ...
                  <p className="content-text">
                    <i>
                      (Các loại cây cảnh chất lượng được mọi nhà lựa chọn)
                    </i>
                  </p>
                </div>
                <img
